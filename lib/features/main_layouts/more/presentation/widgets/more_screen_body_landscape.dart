...
class MoreScreenBodyLandScape extends StatefulWidget {
  const MoreScreenBodyLandScape({super.key});

  @override
  State<MoreScreenBodyLandScape> createState() =>
      _MoreScreenBodyLandScapeState();
}

class _MoreScreenBodyLandScapeState extends State<MoreScreenBodyLandScape> {
                ...
                Center(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            width: 2, color: const Color(0xff959CA8))),
                    child: FittedBox(
                      child: Image.asset(
                        images[0],
                        height: height * 0.034,
