...
import 'package:responsive_adaptive_ui/features/checkout/presentation/widgets/order_tracking_landscape.dart';
...
class _OrderTrackingViewBodyState extends State<OrderTrackingViewBody> {
  ...
  Widget build(BuildContext context) {
    ...
    var orders = ModalRoute.of(context)?.settings.arguments as MakeOrderModel;
    return isLandScape
        ? const OrderTrackingViewBodyLandScape()
        : Padding(
              ...
              builder: (context, constraints) {
                return BlocConsumer<CheckoutBloc, CheckoutState>(
                  listener: (context, state) {
                    if (state.makeOrderState == RequestState.success) {
                    ...
                    return Column(
                      children: [
                        ...
                        Custombutton(
                          title: "Confirm",
                          onPressed: () {
                            bloc.add(CheckoutEvent.makeOrder(orders));
                          },
                        ),
                        SizedBox(
                          height: height * 0.02,
